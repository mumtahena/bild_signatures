...
best_predictors<-apply(pred_sub[,c(34,35,37,160,145,150)],2,scale)
...
basal<-subset(pred_sub[,c(34,35,37,38,160,145,150,179,180,191,192)],pred_sub$PAM50.mRNA.x=="Basal-like")
her<-subset(pred_sub[,c(34,35,37,38,160,145,150,179,180,191,192)],pred_sub$PAM50.mRNA.x=="HER2-enriched")
luminal<-subset(pred_sub[,c(34,35,37,38,160,145,150,179,180,191,192)],pred_sub$PAM50.mRNA.x=="Luminal A"|pred_sub$PAM50.mRNA.x=="Luminal B")
normal<-subset(pred_sub[,c(34,35,37,38,160,145,150,179,180,191,192)],pred_sub$PAM50.mRNA.x=="Normal-like")
