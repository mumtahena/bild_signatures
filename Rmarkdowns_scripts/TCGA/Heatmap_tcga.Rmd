...
all_bad<-subset(bad_exp,(bad_exp$tumor_status=="TUMOR FREE"|bad_exp$tumor_status=="WITH TUMOR")&(bad_exp$treatment_best_response=="Complete Response"|bad_exp$treatment_best_response=="Clinical Progressive Disease")&bad_exp$pharmaceutical_therapy_type=="Chemotherapy"&bad_exp$pr_status_by_ihc!="Positive"&bad_exp$er_status_by_ihc!="Positive"&bad_exp$her2_status_by_ihc!="Positive")

dim(all_bad)
summary(all_bad$treatment_best_response)
all_bad<-subset(bad_exp,bad_exp$treatment_best_response=="Complete Response"|bad_exp$treatment_best_response=="Clinical Progressive Disease")
...
##4th element sample "TCGA-A2-A3XU" received hormanal therapy. so excluding this TCGA-A2-A3XU
not_bad<-not_bad[-7,]
par(mfrow = c(1, 1))
