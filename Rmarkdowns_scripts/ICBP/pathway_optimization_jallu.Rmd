...
correlation_plot<-function(pathway,drug,text,pval){
 plot(pathway,drug,main=text,ylab="Drug Response",xlab="Pathway Activation")
 tmp<-lm(drug~pathway)
 abline(tmp,col="red")
 mtext(side = 1,pval) 
}
...
```{r,echo=FALSE}
options(digits = 2)
pdf("~/Dropbox/bild_signatures/bild_signatures/Results/Drug_correlations.pdf")
par(lwd=4)
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$CPT.11,text="CPT response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'CPT.11',sep='__'),]$Corr,digits = 2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'CPT.11',sep='__'),]$p_val,digits=2), sep=' '))

correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$CGC.11047,text="CGC.11047 response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[141]),'CGC.11047',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[141]),'CGC.11047',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Carboplatin,text="Carboplatin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Carboplatin',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Carboplatin',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Cisplatin,text="Cisplatin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Cisplatin',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Cisplatin',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adap_adap_multi/bad")],pred_drug$Docetaxel,text="Docetaxel response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adap_adap_multi/bad")]),'Docetaxel',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adap_adap_multi/bad")]),'Docetaxel',sep='__'),]$p_val,digits=4), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$Epirubicin,text="Epirubicin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Epirubicin',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Epirubicin',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$Oxaliplatin,text="Oxaliplatin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Oxaliplatin',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Oxaliplatin',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$Doxorubicin,text="Doxorubicin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Doxorubicin',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Doxorubicin',sep='__'),]$p_val,digits=2), sep=' '))
#correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$ICRF.193,text="ICRF.193 response versus the BAD pathway prediction",pval = paste("Cor:",cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'ICRF.193',sep='__'),]$Corr,"p-value:",cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'ICRF.193',sep='__'),]$p_val, sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Paclitaxel,text="Paclitaxel response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Paclitaxel',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Paclitaxel',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$Topotecan,text="Topotecan response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Topotecan',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Topotecan',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")],pred_drug$Sigma.AKT1.2.inhibitor,text="Sigma.AKT1.2.inhibitor response\n versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Sigma.AKT1.2.inhibitor',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad_igf1r/adapB_multi/bad")]),'Sigma.AKT1.2.inhibitor',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$GSK2141795,text="GSK2141795 response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'GSK2141795',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'GSK2141795',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Everolimus,text="Everolimus response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Everolimus',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Everolimus',sep='__'),]$p_val,digits=4), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Temsirolimus,text="Temsirolimus response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Temsirolimus',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Temsirolimus',sep='__'),]$p_val,digits=2), sep=' '))
correlation_plot(pred_drug[,which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")],pred_drug$Rapamycin,text="Rapamycin response versus the BAD pathway prediction",pval = paste("Cor:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Temsirolimus',sep='__'),]$Corr,digits=2),"p-value:",round(cor_tables[paste(gsub(pattern='/',replacement = '.',colnames(pred_drug)[which(colnames(pred_drug)=="her2_bad/adap_adap_multi/bad")]),'Temsirolimus',sep='__'),]$p_val,digits=2), sep=' '))
dev.off()
...
boxplot(best_pathway_predictions[,2]~subtype_her2,main="BAD across breast cell lines",col=2:5,ylim=c(-2.5,2),ylab="Scaled pathway activity")
...
best_pred_pro<-merge_drop(best_pathway_predictions,proteomics_cell,by=0)
cor(best_pred_pro[,1],best_pred_pro$Akt)
cor(best_pred_pro[,1],best_pred_pro$Aktp308)
cor(best_pred_pro[,1],best_pred_pro$Aktp473)
cor(best_pred_pro[,2],best_pred_pro$Akt)
cor(best_pred_pro[,2],best_pred_pro$Aktp308)
cor(best_pred_pro[,2],best_pred_pro$Aktp473)
cor(best_pred_pro[,3],best_pred_pro$Bcl2)

cor(best_pred_pro[,4],best_pred_pro$IGFR1)
cor(best_pred_pro[,5],best_pred_pro$MAPKp)
cor(best_pred_pro[,5],best_pred_pro$ERK2)
