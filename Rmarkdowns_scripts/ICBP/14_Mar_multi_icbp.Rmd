...
sub_dir<-paste(basedir,"akt_150",sep='/')
dir.create( sub_dir)
...
#set.seed(1234)
#assign.wrapper(trainingData=cbind(c_gfp,c_akt), testData=c_test, trainingLabel=trainingLabela, geneList=NULL, n_sigGene=150, adaptive_B=T, adaptive_S=F, mixture_beta=F, outputDir=sub_dir, theta0=0.05, theta1=0.9, iter=100000, burn_in=5000,p_beta=0.5)

sub_dir<-paste(basedir,"akt_0.1",sep='/')
dir.create( sub_dir)
assign_easy_multi(trainingData = cbind(c_gfp,c_akt),test=c_test,trainingLabel1 = trainingLabela,g=150,out_dir_base = sub_dir,single = 1)
...
trainingLabelh<-list(control=list(her2=1:12),her2=13:17)
sub_dir<-paste(basedir,"her2_25",sep='/')
dir.create( sub_dir)
...
trainingLabeli<-list(control=list(igf1r=1:12),igf1r=13:18)
sub_dir<-paste(basedir,"igf1r_15",sep='/')
dir.create( sub_dir)
...
trainingLabeli<-list(control=list(igf1r=1:12),igf1r=13:18)
sub_dir<-paste(basedir,"igf1r_45",sep='/')
dir.create( sub_dir)
...
trainingLabeli<-list(control=list(igf1r=1:12),igf1r=13:18)
sub_dir<-paste(basedir,"igf1r_75",sep='/')
dir.create( sub_dir)
...
trainingLabele<-list(control=list(erk=1:12),erk=13:18)
sub_dir<-paste(basedir,"erk_65",sep='/')
dir.create( sub_dir)
