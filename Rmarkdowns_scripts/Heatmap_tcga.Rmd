...
#filtering out the hormone positive samples
all_bad<-subset(bad_exp,(bad_exp$pr_status_by_ihc!=c("[Not Evaluated]","Indeterminate")&bad_exp$er_status_by_ihc!="[Not Evaluated]"&bad_exp$her2_status_by_ihc!=c("[Not Evaluated]","Indeterminate","Equivocal")))
...
all_bad<-subset(all_bad,all_bad$vital_status=="Alive"|all_bad$vital_status=="Dead")
#all_bad<-subset(bad_exp,bad_exp$tumor_status=="TUMOR FREE"|bad_exp$tumor_status=="WITH TUMOR")
dim(all_bad)
