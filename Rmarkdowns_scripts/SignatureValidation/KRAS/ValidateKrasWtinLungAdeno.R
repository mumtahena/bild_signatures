...
for (folder in foldersWithProbabilities)
{
	...
	stripchart(list(probabilitiesKrasWt, probabilitiesKrasMut), vertical = TRUE, method = "jitter", pch = 21, col = "maroon", bg = "bisque", cex.lab=1, cex.axis=1, xaxt="n", xlab="Lung adenocarcinoma K-Ras mutation status", ylab="Probability of K-Ras (WT) activation", xlim=c(0,3), ylim=c(0,1))
