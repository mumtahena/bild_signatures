...
ovca<-read.table("~/Dropbox/Datasets/OVCA_in_SYMBOLs.txt", sep='\t',header=1,row.names=1)
skcm<-read.table("~/Dropbox/Datasets/SKCM_TPMlog_RNA-seq.txt", header=1,row.names=1, sep='\t')
dim(skcm)
