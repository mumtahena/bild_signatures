...
CCLE_Breast_Metadata_Removed=read.table("~/Documents/ThesisWork/GitRepos/bild_signatures/CCLE/CCLE_Breast_RNAseq_TPMlog.txt", sep='\t', check.names = FALSE, stringsAsFactors=FALSE, header=1, row.names=1)
...
gjhCorrelate Adaptive results with Non-apative results
```{r}
