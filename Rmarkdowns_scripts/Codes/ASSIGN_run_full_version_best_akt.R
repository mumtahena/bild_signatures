...
akt_bad_her2_raf_genelist<-c(akt_75_genelist,bad_200_genelist,her2_15_genelist,raf_100_genelist)
names(akt_bad_her2_raf_genelist)<-names(trainingLabel)[-1]
testSig_multi(sigProteins="akt_bad_her2_raf", geneList=akt_bad_her2_raf_genelist, trainingData = cbind(c_gfp,c_akt,c_bad,c_her2,c_raf), testData = c_test, trainingLabel = trainingLabel)
