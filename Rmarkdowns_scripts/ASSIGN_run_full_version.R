...
dim(test)
expr_all_test_f<-merge_drop(expr_all,test,by=0)
...
##best_akt
trainingLabel<-list(control=list(akt=1:12,bad=1:12,her2=1:12,raf=1:12),akt=13:18, bad=19:24,her2=25:29,raf=30:35)
akt_bad_her2_raf_genelist<-c(akt_75_genelist,bad_200_genelist)
names(akt_bad_her2_raf_genelist)<-names(trainingLabel)[-1]
testSig_multi(sigProteins="akt_bad_her2_raf", geneList=akt_bad_genelist, trainingData = cbind(c_gfp,c_akt,c_bad,c_her2,c_raf), testData = c_test, trainingLabel = trainingLabel)
