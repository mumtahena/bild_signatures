...
drug_srt<-subset(drugs,select = c("Lapatinib","Sigma.AKT1.2.inhibitor"))
...
colnames(cors)=c("Lapatinib","Sigma.akt.1.2.inhibitor")
pathways<-pred_drug[,1:54]
drugs<-pred_drug[,55:56]
...
write.table(cors,"~/Dropbox/bild_signatures/bild_signatures/Results/cor_mat_lapatinib_sigma_akt.txt",sep = '\t',col.names = NA,quote=F)
...
write(file="~/Dropbox/bild_signatures/bild_signatures/pathway prediction drug response results.xls","Correlations for pathway predictions with Lapatinib and Sigma.AKT.inhibitor in BASAL subtype")
...
cor(her[,1:54],her$Lapatinib,use="pairwise.complete.obs")
cor(her[,1:54],her$Sigma.AKT1.2.inhibitor,use="pairwise.complete.obs")
...
heatmap.2(as.matrix(claudin[,1:54]),col=my_palette,dendrogram="none",lmat=rbind( c(0, 3, 4), c(2,1,0 ) ), lwid=c(1.5, 4, 2 ), trace="none",margins=c(12,9),main="Claudin Multi")
...
cor(luminal[,1:54],luminal$Lapatinib,use="pairwise.complete.obs")
cor(luminal[,1:54],luminal$Sigma.AKT1.2.inhibitor,use="pairwise.complete.obs")
heatmap.2(as.matrix(luminal[,1:54]),col=my_palette,dendrogram="none",lmat=rbind( c(0, 3, 4), c(2,1,0 ) ), lwid=c(1.5, 4, 2 ), trace="none",margins=c(12,9),main="Luminal Multi")
