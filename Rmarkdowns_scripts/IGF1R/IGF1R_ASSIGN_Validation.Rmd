...
for(i in 1:length(colnames(data)))
  ...
  print(cor(pred_drug[i],pred_drug$Tykerb.IGF1R..1.1.="na.or.complete"))
  print("correlation with GSK1838705")
  print(cor(pred_drug[i],pred_drug$GSK1838705.="na.or.complete"))
...
for(i in 2:(length(colnames(data))+1))
{
  ...
  print(paste("pearson's correlation between IGF1R CNV and ",colnames(combined)[i]),sep='')
