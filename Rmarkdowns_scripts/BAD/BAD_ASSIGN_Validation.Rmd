...
feature<-as.matrix(read.table("~/Dropbox/Datasets/GFP18_bad_BAD_HER2_IGF1R_RAF_ERK.tpmlog", sep='\t', stringsAsFactors=FALSE, header=1, row.names=1))
#head(feature)
...
for(i in 1:length(colnames(data)))
  ...
  print("correlation with Sigma bad1/2..an bad  inhibitor")
  print(cor(pred_drug[i],pred_drug$Sigma.bad1.2.inhibitor,use="na.or.complete"))
  print("correlation with GSK2126458..an bad  inhibitor")
  print(cor(pred_drug[i],pred_drug$GSK2126458,use="na.or.complete"))
  print("correlation with TRIciribine..an bad  inhibitor")
